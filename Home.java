...
public class Home extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e) 
    {
        ...
        else if( e.getSource().equals(comboBoxPlayer) || e.getSource().equals(comboBoxCPUplayer) ) {
            Game.humanPlayers = Integer.valueOf((String) comboBoxPlayer.getSelectedItem());
            Game.CPUPlayers =   Integer.valueOf( (String) comboBoxCPUplayer.getSelectedItem() );
            }
